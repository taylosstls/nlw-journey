...
export function Toast({ children, visible }: ToastProps) {
  return (
    <div className={`absolute text-xs px-3 py-1.5 pointer-events-none -bottom-5 -right-3.5 bg-lime-300 text-lime-950 rounded-lg transition-opacity duration-300 ${visible ? 'opacity-100' : 'opacity-0'}`}>
      {children}
